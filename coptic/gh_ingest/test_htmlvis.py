...
from gh_ingest.htmlvis import (
    generate_visualization, HtmlGenerationException, Directive, TokDirective, AnnDirective,
    ValueDirective, AnnAndValueDirective, SgmlElement, parse_config, parse_text, render_html,
    TriggerTypes, ContentTypes
)
...
ⲉⲛⲧ
    ...
    def test_render_html(self):
        toks = ['ϭⲟⲗ', 'ⲉⲛⲧ']
        elts = [
            SgmlElement("norm", [("open_line", "0"), ("close_line", "0"), ("xml:id", "u1"), ("norm", "ϭⲟⲗ")]),
            SgmlElement("func", [("open_line", "0"), ("close_line", "0"), ("func", "root")]),
            SgmlElement("pos", [("open_line", "0"), ("close_line", "0"), ("pos", "N")]),
            SgmlElement("lemma", [("open_line", "0"), ("close_line", "0"), ("lemma", "ϭⲟⲗ")])
        ]
        directives = [
