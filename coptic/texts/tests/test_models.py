...
class TestHtmlVisualization(TestCase):
    ...
    def test_visualization_format_property(self):
        self.assertEqual(
            self.visualization.visualization_format.slug,
            self.norm_format.slug
        )
        self.assertEqual(
            self.visualization.visualization_format.title,
            self.norm_format.title
        )
...
class TestSpecialMeta(TestCase):
    def test_get_all_special_metas(self):
        ...
        expected_names = {
            'corpus', 'author', 'people', 'places', 'msName',
            'annotation', 'translation', 'arabic_translation'
        }
