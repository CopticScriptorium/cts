...
class TestSearch(unittest.TestCase):
    ...
    def test_reduce_text_with_ellipsis_single_highlight(self):
        ...
        expected_output = 'This is [...] very good <span class="highlight">test</span> case with [...] a highlight.'
        result = self.search.reduce_text_with_ellipsis(html_text, 2)
        self.assertEqual(result, expected_output)
    ...
    def test_reduce_text_with_ellipsis_multiple_highlights(self):
        ...
        expected_output = 'This is [...] a <span class="highlight">test</span> sentence with [...] sentence with <span class="highlight">multiple</span>  [...] multiple highlights.'
        result = self.search.reduce_text_with_ellipsis(html_text, 2)
        self.assertEqual(result, expected_output)
    ...
    def test_reduce_text_with_ellipsis_multiple_highlights_and_long_segments(self):
        ...
        expected_output = 'Beginning: This [...] and such <span class="highlight">test</span> another long [...] is a <span class="highlight">second</span> long sentence [...] and such <span class="highlight">multiple</span> highlights. This [...] the end.'
        result = self.search.reduce_text_with_ellipsis(html_text, 2)
        self.assertEqual(result, expected_output)
    ...
    def test_reduce_text_with_ellipsis_context(self):
        ...
        expected_output = 'This [...] a <span class="highlight">test</span> sentence [...] highlight.'
        result = self.search.reduce_text_with_ellipsis(html_text, n=1)
        self.assertEqual(result, expected_output)

    def test_reduce_text_with_ellipsis_no_match(self):
        html_text = '<p>This is a <span class="highlight">test</span> sentence with a highlight.</p>'
        expected_output = ' <span class="highlight">test</span> '
        result = self.search.reduce_text_with_ellipsis(html_text, n=0)
        self.assertEqual(result, expected_output)
